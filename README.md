...
A complete documentation of my **54 Days of Machine Learning**. Though I intended to do it for **100 Days**, I completed the
required stuffs in only **54 Days**. Feel free to go through it.
...
| 4.       | [**Book Recommendation System**](https://github.com/iamshishirbhattarai/Machine-Learning/tree/main/Book%20Recommendation%20System)                                                               | ✅          |
...
| [Day 7](Day7)   | Logistic Regression, Softmax Regression, Soft Margin Classification, Support Vector Machines, SVM Kernels                                                                    | [Hands-On Machine Learning with Scikit-Learn, Keras, and TensorFlow](https://github.com/ageron/handson-ml3) <br><br> [StatQuest with Josh Starmer](https://www.youtube.com/watch?v=efR1C6CvhmE)                                                     |
 ...
 | [Day 9](Day9)   | Ensemble learning Intro, Voting Classifiers and its types, Bagging, Pasting & Random Forest, Boosting, AdaBoost                                                              | [Hands-On Machine Learning with Scikit-Learn, Keras, and TensorFlow](https://github.com/ageron/handson-ml3)                                                                                                                                         |
  ...
  | [Day 13](Day13) | Feature selection, Feature Extraction, Compression & Decompression using PCA, Variance Threshold, Elbow Mehhod                                                               | [Hands-On Machine Learning with Scikit-Learn, Keras, and TensorFlow](https://github.com/ageron/handson-ml3) <br> <br> [Machine Learning Scientist With Python](https://app.datacamp.com/learn/career-tracks/machine-learning-scientist-with-python) | 
   ...
   | [Day 53](Day53) | Recommender System, Collaborative Filtering, Content-Based Filtering                                                                                                         | [GeeksForGeeks](https://www.geeksforgeeks.org/recommendation-system-in-python/)                                                                                                                                                                     |
   | [Day 54](Day54) | [**Book Recommendation System**](https://github.com/iamshishirbhattarai/Machine-Learning/tree/main/Book%20Recommendation%20System)                                           | [CampusX](https://www.youtube.com/watch?v=1YoD0fg3_EM&t=3366s)                                                                                                                                                                                      |
___
## Day 1 
...
Today I revised the **Recommender system** and it's two types : **Collaborative Filtering** and  **Content-Based Filtering**.
If used both, it's also known as **Hybrid method**.
On this journey, I'll be more focusing on **Collaborative Filtering** rather than the other ones. Let's summarise the concepts
behind them: <br> <br>

- A **recommender system** is an algorithm-driven tool that suggests personalized items or content to users based on their past behavior,
preferences, or the preferences of similar users. It enhances user experience on platforms by providing relevant recommendations,
such as movies, products, or music. There are three main types of recommender systems: **content-based filtering**, **collaborative filtering**, 
and **hybrid methods**, each using different techniques to predict user preferences. <br> <br>
- Collaborative filtering is a recommendation technique that predicts a user's preferences based on the behavior or preferences of similar users.
It works by analyzing patterns in user interactions, such as ratings, purchases, or views, to identify like-minded groups.
There are two types: **user-based collaborative filtering**, which recommends items favored by users with similar tastes, and
**item-based collaborative filtering**, which suggests items that are similar to what the user has already liked.
This method is effective but may struggle with sparse data or new users/items (**the cold-start problem**). <br> <br>
- The **cold-start problem** occurs in recommender systems when there is insufficient data to make accurate recommendations.
This typically happens in three scenarios: when a new user joins the system with no prior interaction history, when a new
item is added with no user feedback, or when the system itself is new. Since collaborative filtering relies on user
interactions and preferences, the lack of data in these situations makes it difficult to generate personalized recommendations. 
Solutions often involve hybrid approaches or default recommendations until enough data is collected. <br> <br>
- **Content-based filtering** recommends items to users based on the characteristics or features of items they have previously 
liked or interacted with. It uses item attributes, such as genre, keywords, or descriptions, to match similar items and make personalized suggestions.
<br> <br>
**ChatGpt Generated Image**<br> <br>
 ![recommender_system](Day53/recommender_system.png)

___
## Day 54

Today I did a project on **Recommender System**. The project is about **Book Recommendation System** Using **Collaborative Filtering**
and also **Popularity Based**. Used **Cosine Similarity** to find out the similarity score of two book based on the ratings
by the users. <br> <br>
- ![recommend](Day54/recommend.png) <br> <br>

Visit the full project : [**Book Recommendation System**](https://github.com/iamshishirbhattarai/Machine-Learning/tree/main/Book%20Recommendation%20System)

___

With this I am concluding my Journey here. Though I had started to do it for **100 Days** , I achieved everything from
this journey that I had intended to within **54 Days**. With better research on syllabus, starting the **Deep Learning** Journey
very soon. <br> <br>
